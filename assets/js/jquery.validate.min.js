...
$.validator.addMethod("percentage", function(value, element) {
	return this.optional(element) || /^((100)|(\d{1,2}(\.\d*)?))%?$/.test(value);
}, "Please enter a value with percentage");
	
$.validator.addMethod("twodecimal", function(value, element) {
	return this.optional(element) || /^[0-9]*(\.[0-9]{0,2})?$/.test(value);
}, "Please enter a value with two decimal");
